...
export default function PaymentUpdateUnified() {
  ...
  //       {/* SUGGESTION BOX */}
  //       {suggestions.length > 0 && (
  //         <ul className="absolute z-20 w-full bg-white shadow-lg border rounded-md mt-1 max-h-60 overflow-y-auto">
  //           {suggestions.map((item) => (
  //             <li
  //               key={item._id}
  ...
  //         className="space-y-3 bg-white rounded-lg p-4 shadow-md border"
  //       >
  //         <div>
